      ...
      <> 
        <div className=" ">
          ...
          <table className="w-full rounded-xl overflow-hidden">
            <thead>
              <tr className=" sticky top-0   ">
                <th className="bg-white p-3 text-sm md:text-base  ">کاربری </th>
                <th className="bg-white p-3 text-sm md:text-base ">نشانی </th>
                <th className="bg-white p-3 text-sm md:text-base "> متراژ (مترمربع)</th>
                <th className="bg-white p-3 text-sm md:text-base ">مالک/ استیجاری </th>
                <th className="bg-white p-3 text-sm md:text-base ">تعداد کارکنان </th>
              </tr>
            </thead>
            <tbody>
              <tr className="bg-white border-b">
                <td className="p-2 sm:p-4 text-xs text-gray-800 font-bold">
                  دفتر مرکزی
                </td>
                <td className="p-2 sm:p-4 text-xs text-gray-600 font-bold">
                  <textarea
                    className=" text-xs h-12 border border-gray-300 rounded-xl w-full    "
                    cols="30"
                    rows="10"
                    id="0"
                ...
                <td className="p-2 sm:p-4 text-xs text-gray-600 font-bold">
                  <input
                    type="number"
                    className="border border-gray-300 rounded-xl md:w-21 w-full "
                    onChange={changeHandler}
                    name="meterage"
                ...
                <td className="p-2 sm:p-4 text-xs text-gray-600 font-bold">
                  <select
                    ...
                    onChange={changeHandler}
                    id="0"
                    className="border-gray-300 rounded-xl md:w-24 text-xs w-full"
                  >
              ...
              <tr className="bg-white ">
                <td className="p-2 sm:p-4 text-xs text-gray-800 font-bold">انبار</td>
                <td className="p-2 sm:p-4 text-xs text-gray-600 font-bold">
                  <textarea
                    className=" text-xs h-12 border border-gray-300 rounded-xl w-full    "
                    id="2"
