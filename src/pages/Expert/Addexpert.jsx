  ...
  return (
    <form className="bg-white rounded-3xl mt-3 p-3">
      ...
      <div className="flex flex-wrap">
        <div className="md:w-1/2 xl:w-96 w-full px-1">
          <div className="mt-3  border rounded-2xl p-2 overflow-hidden">
      ...
      <div className="w-full">
        ...
        <div className="my-4 relative border rounded-xl xl:w-96  w-full overflow-hidden">
          <select
            name=""
            id=""
            className="relative   w-full pt-5 p-2 outline-none text-sm text-gray-500 border-0"
          >
