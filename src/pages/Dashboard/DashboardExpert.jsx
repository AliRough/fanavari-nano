      ...
      <div className="p-6 flex flex-col gap-6">
        ...
        <div className="flex gap-6 text-white flex-wrap sm:flex-nowrap">
          <div className="sm:w-1/3 w-full h-c-8 flex justify-between items-center rounded-2xl bg-c-5 relative overflow-hidden pr-11">
            <Link to="/panel/expertViewAllRequest"  className="z-10">مشاهده درخواست ها</Link>
            <div>
              <img
          ...
          <div className="sm:w-1/3 w-full h-c-8 flex justify-between items-center rounded-2xl bg-c-5 relative overflow-hidden pr-11">
          <Link to="/panel/testtiketsexpert"  className="z-10">مشاهده تیکت ها</Link>
            <div>
              <img
          ...
          <div className="sm:w-1/3 w-full h-c-8 flex justify-between items-center rounded-2xl bg-c-5 relative overflow-hidden pr-11">
          <Link to="/panel/addTicketE"  className="z-10">ثبت تیکت</Link>
            <div>
              <img
                className="absolute left-1 inset-y-0"
                src={Ellipse6}
