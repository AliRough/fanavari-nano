  ...
  return (
    <div className="flex items-center justify-between w-full h-c-6 rounded-3xl bg-c-2 px-7 relative">
      <div className=" flex items-center ">
        ...
        <form className="flex items-center  md:w-80 h-14 p-4 gap-4 bg-white rounded-c border border-c-7 w-max">
          <div>
            <img className="w-3.5 h-3.5" src={Vector3} alt="" />
          </div>
            ...
            {showModal && (
              ...
              >
                ...
                <div class="flex items-center gap-4">
                  ...
                  <a class="text-xs flex-1 text-c-9">خروج </a>
                </div>
              </div>
            )}
          </button>
